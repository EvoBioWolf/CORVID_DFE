...
#Set folder containing configuration files
scripts='/dss/dsslegfs01/pr53da/pr53da-dss-0018/projects/2017__DFErecomb/alpha/Final_Datasets/DFEalpha/scripts'

for f in $(ls 0fold_real.sfs | sed 's/.sfs//g') ; do 
mkdir ${f}_1e
cp ${f}.sfs ${f}_1e/sfs_malformatted.txt

cd ${f}_1e
sed '1,3c 1' sfs_malformatted.txt > sfs.txt
${software}/est_dfe -c ${scripts}/1_est_dfe_1e-site_class-0_config.txt
${software}/est_dfe -c ${scripts}/2_est_dfe_1e-site_class-1_config.txt
